...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support";
