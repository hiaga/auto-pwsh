...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models
{
    ...
    public partial class BackupInstancesValidateForBackupAcceptedResponseHeaders :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.IBackupInstancesValidateForBackupAcceptedResponseHeaders,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.IBackupInstancesValidateForBackupAcceptedResponseHeadersInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.IHeaderSerializable
    {
        ...
        void Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.IHeaderSerializable.ReadHeaders(global::System.Net.Http.Headers.HttpResponseHeaders headers)
        {
            ...
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.IBackupInstancesValidateForBackupAcceptedResponseHeadersInternal)this).Location = System.Linq.Enumerable.FirstOrDefault(__locationHeader) is string __headerLocationHeader ? __headerLocationHeader : (string)null;
            }
            if (headers.TryGetValues("Retry-After", out var __retryAfterHeader))
            {
                ((Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.IBackupInstancesValidateForBackupAcceptedResponseHeadersInternal)this).RetryAfter = System.Linq.Enumerable.FirstOrDefault(__retryAfterHeader) is string __headerRetryAfterHeader ? int.TryParse( __headerRetryAfterHeader, out int __headerRetryAfterHeaderValue ) ? __headerRetryAfterHeaderValue : default(int?) : default(int?);
            }
        }
    }
