namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001
{
    ...
    public partial class ScheduleBasedBackupCriteria
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IScheduleBasedBackupCriteria.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IScheduleBasedBackupCriteria.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IScheduleBasedBackupCriteria FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonObject json ? new ScheduleBasedBackupCriteria(json) : null;
        }
        ...
        internal ScheduleBasedBackupCriteria(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonObject json)
        {
            ...
            __backupCriteria = new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.BackupCriteria(json);
            ...
            {_daysOfMonth = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonArray>("daysOfMonth"), out var __jsonDaysOfMonth) ? If( __jsonDaysOfMonth as Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IDay[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IDay) (Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.Day.FromJson(__p) )) ))() : null : DaysOfMonth;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="ScheduleBasedBackupCriteria" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ScheduleBasedBackupCriteria" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.SerializationMode serializationMode)
        {
            ...
            {
                var __m = new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.XNodeArray();
                foreach( var __n in this._daysOfTheWeek )
                {
                    AddIf(null != (((object)__n)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonString(__n.ToString()) : null ,__m.Add);
                }
                container.Add("daysOfTheWeek",__m);
            }
            if (null != this._monthsOfYear)
            {
                var __h = new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.XNodeArray();
                foreach( var __i in this._monthsOfYear )
                {
                    AddIf(null != (((object)__i)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonString(__i.ToString()) : null ,__h.Add);
                }
                container.Add("monthsOfYear",__h);
            }
            if (null != this._scheduleTime)
            {
                var __c = new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.XNodeArray();
                foreach( var __d in this._scheduleTime )
                {
                    AddIf((Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonString(__d.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) ,__c.Add);
                }
                container.Add("scheduleTimes",__c);
            }
            if (null != this._weeksOfTheMonth)
            {
                var ___x = new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.XNodeArray();
                foreach( var ___y in this._weeksOfTheMonth )
                {
                    AddIf(null != (((object)___y)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json.JsonString(___y.ToString()) : null ,___x.Add);
                }
