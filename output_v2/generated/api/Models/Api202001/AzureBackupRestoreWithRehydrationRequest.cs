namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001
{
    ...
    public partial class AzureBackupRestoreWithRehydrationRequest :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IAzureBackupRestoreWithRehydrationRequest,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IAzureBackupRestoreWithRehydrationRequestInternal,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.IValidates
    {
        /// <summary>
        /// Backing field for Inherited model <see cref= "Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IAzureBackupRecoveryPointBasedRestoreRequest"
        /// />
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IAzureBackupRecoveryPointBasedRestoreRequest __azureBackupRecoveryPointBasedRestoreRequest = new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.AzureBackupRecoveryPointBasedRestoreRequest();
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.PropertyOrigin.Inherited)]
        public string RestoreTargetInfoRecoveryOption { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IAzureBackupRestoreRequestInternal)__azureBackupRecoveryPointBasedRestoreRequest).RestoreTargetInfoRecoveryOption; }
    ...
    public partial interface IAzureBackupRestoreWithRehydrationRequest :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IAzureBackupRecoveryPointBasedRestoreRequest
    {
        /// <summary>Priority to be used for rehydration. Values High or Standard</summary>
    ...
    internal partial interface IAzureBackupRestoreWithRehydrationRequestInternal :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IAzureBackupRecoveryPointBasedRestoreRequestInternal
    {
        /// <summary>Priority to be used for rehydration. Values High or Standard</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.RehydrationPriority RehydrationPriority { get; set; }
        /// <summary>Retention duration in ISO 8601 format i.e P10D .</summary>
