...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.DataStoreTypes ArchiveStore = @"ArchiveStore";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.DataStoreTypes SnapshotStore = @"SnapshotStore";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.DataStoreTypes VaultStore = @"VaultStore";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.DataStoreTypes e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.DataStoreTypes e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.DataStoreTypes e1, Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.DataStoreTypes e2)
        {
            return !e2.Equals(e1);
        }
