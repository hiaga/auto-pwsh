...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.AbsoluteMarker AllBackup = @"AllBackup";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.AbsoluteMarker FirstOfDay = @"FirstOfDay";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.AbsoluteMarker FirstOfMonth = @"FirstOfMonth";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.AbsoluteMarker FirstOfWeek = @"FirstOfWeek";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.AbsoluteMarker FirstOfYear = @"FirstOfYear";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.AbsoluteMarker e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.AbsoluteMarker e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.AbsoluteMarker e1, Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.AbsoluteMarker e2)
        {
            return !e2.Equals(e1);
        }
