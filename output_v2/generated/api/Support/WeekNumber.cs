...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.WeekNumber First = @"First";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.WeekNumber Fourth = @"Fourth";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.WeekNumber Last = @"Last";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.WeekNumber Second = @"Second";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.WeekNumber Third = @"Third";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.WeekNumber e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.WeekNumber e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.WeekNumber e1, Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.WeekNumber e2)
        {
            return !e2.Equals(e1);
        }
