# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.DataProtectionBackup.private.dll')

  # Get the private module's instance
  $instance = [Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Module]::Instance
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Az.DataProtectionBackup.custom.psm1'
