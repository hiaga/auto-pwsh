...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/test-azdataprotectionbackupinstancerestore
schema: 2.0.0
---
...
### ValidateViaIdentity
```
Test-AzDataProtectionBackupInstanceRestore -InputObject <IDataProtectionBackupIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.IValidateRestoreRequestObject
