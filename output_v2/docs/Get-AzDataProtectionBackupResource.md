...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/get-azdataprotectionbackupresource
schema: 2.0.0
---

# Get-AzDataProtectionBackupResource
...
### Get (Default)
```
Get-AzDataProtectionBackupResource -GroupName <String> -OperationId <String> -VaultName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataProtectionBackupResource -InputObject <IDataProtectionBackupIdentity> [-DefaultProfile <PSObject>]
