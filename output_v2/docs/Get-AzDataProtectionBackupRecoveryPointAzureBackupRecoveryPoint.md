...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/get-azdataprotectionbackuprecoverypointazurebackuprecoverypoint
schema: 2.0.0
---

# Get-AzDataProtectionBackupRecoveryPointAzureBackupRecoveryPoint
...
### Get (Default)
```
Get-AzDataProtectionBackupRecoveryPointAzureBackupRecoveryPoint -BackupInstanceName <String>
...
### GetViaIdentity
```
Get-AzDataProtectionBackupRecoveryPointAzureBackupRecoveryPoint -InputObject <IDataProtectionBackupIdentity>
