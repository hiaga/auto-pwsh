...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/get-azdataprotectionbackuppolicy
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzDataProtectionBackupPolicy -InputObject <IDataProtectionBackupIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
