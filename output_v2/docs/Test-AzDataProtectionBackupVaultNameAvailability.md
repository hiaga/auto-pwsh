...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/test-azdataprotectionbackupvaultnameavailability
schema: 2.0.0
---
...
### CheckViaIdentity
```
Test-AzDataProtectionBackupVaultNameAvailability -InputObject <IDataProtectionBackupIdentity>
...
```
Test-AzDataProtectionBackupVaultNameAvailability -InputObject <IDataProtectionBackupIdentity> [-Name <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001.ICheckNameAvailabilityRequest
