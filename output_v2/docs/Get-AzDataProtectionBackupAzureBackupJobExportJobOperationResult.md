...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/get-azdataprotectionbackupazurebackupjobexportjoboperationresult
schema: 2.0.0
---

# Get-AzDataProtectionBackupAzureBackupJobExportJobOperationResult
...
### Get (Default)
```
Get-AzDataProtectionBackupAzureBackupJobExportJobOperationResult -OperationId <String>
...
### GetViaIdentity
```
Get-AzDataProtectionBackupAzureBackupJobExportJobOperationResult -InputObject <IDataProtectionBackupIdentity>
