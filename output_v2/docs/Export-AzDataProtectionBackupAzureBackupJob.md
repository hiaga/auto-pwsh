...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/export-azdataprotectionbackupazurebackupjob
schema: 2.0.0
---

# Export-AzDataProtectionBackupAzureBackupJob
...
### Export (Default)
```
Export-AzDataProtectionBackupAzureBackupJob -ResourceGroupName <String> -VaultName <String>
...
### ExportViaIdentity
```
Export-AzDataProtectionBackupAzureBackupJob -InputObject <IDataProtectionBackupIdentity>
