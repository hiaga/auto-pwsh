...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/get-azdataprotectionbackuprecoverypoint
schema: 2.0.0
---

# Get-AzDataProtectionBackupRecoveryPoint
...
### Get (Default)
```
Get-AzDataProtectionBackupRecoveryPoint -BackupInstanceName <String> -Id <String> -ResourceGroupName <String>
 -VaultName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataProtectionBackupRecoveryPoint -InputObject <IDataProtectionBackupIdentity>
