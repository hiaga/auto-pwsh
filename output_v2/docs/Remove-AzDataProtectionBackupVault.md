...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/remove-azdataprotectionbackupvault
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzDataProtectionBackupVault -InputObject <IDataProtectionBackupIdentity> [-DefaultProfile <PSObject>]
