...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType ArchiveStore = @"ArchiveStore";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType SnapshotStore = @"SnapshotStore";

        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType VaultStore = @"VaultStore";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType e1, Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType e2)
        {
            return !e2.Equals(e1);
        }
