namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha
{
    ...
    public partial class ExportJobsResult :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IExportJobsResultInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IExportJobsResultInternal.BlobSasKey { get => this._blobSasKey; set { {_blobSasKey = value;} } }

        /// <summary>Internal Acessors for BlobUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IExportJobsResultInternal.BlobUrl { get => this._blobUrl; set { {_blobUrl = value;} } }

        /// <summary>Internal Acessors for ExcelFileBlobSasKey</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IExportJobsResultInternal.ExcelFileBlobSasKey { get => this._excelFileBlobSasKey; set { {_excelFileBlobSasKey = value;} } }

        /// <summary>Internal Acessors for ExcelFileBlobUrl</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IExportJobsResultInternal.ExcelFileBlobUrl { get => this._excelFileBlobUrl; set { {_excelFileBlobUrl = value;} } }
