...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Description(@"Validates if Restore can be triggered for a DataSource")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IValidateRestoreRequestObject _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.ValidateRestoreRequestObject();

        /// <summary>Validate restore request object</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IValidateRestoreRequestObject ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType))]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType RestoreRequestObjectSourceDataStoreType { get => ParametersBody.RestoreRequestObjectSourceDataStoreType; set => ParametersBody.RestoreRequestObjectSourceDataStoreType = value; }
        ...
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Cmdlets.TestAzDataProtectionBackupInstanceRestore_ValidateViaIdentityExpanded Clone()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BackupInstancesValidateRestoreViaIdentity(InputObject.Id, ParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupInstancesValidateRestore(InputObject.VaultName ?? null, InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.BackupInstanceName ?? null, ParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
