...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DppGetOperationResultPatch=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/operationResults/{operationId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataProtectionBackupResource_Get")]
    ...
    public partial class GetAzDataProtectionBackupResource_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Alias("ResourceGroupName")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDataProtectionBackupResource_Get" /> cmdlet class.
        /// </summary>
        public GetAzDataProtectionBackupResource_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DppGetOperationResultPatch(VaultName, GroupName, SubscriptionId, OperationId, onOk, onAccepted, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  VaultName=VaultName,GroupName=GroupName,SubscriptionId=SubscriptionId,OperationId=OperationId})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { VaultName=VaultName, GroupName=GroupName, SubscriptionId=SubscriptionId, OperationId=OperationId })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { VaultName=VaultName, GroupName=GroupName, SubscriptionId=SubscriptionId, OperationId=OperationId })
                    {
