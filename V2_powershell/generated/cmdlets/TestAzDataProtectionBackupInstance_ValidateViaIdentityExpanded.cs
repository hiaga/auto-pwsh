...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Description(@"Validate whether adhoc backup will be successful or not")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IBackupInstance BackupInstance { get => ParametersBody.BackupInstance ?? null /* object */; set => ParametersBody.BackupInstance = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IValidateForBackupRequest _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.ValidateForBackupRequest();

        /// <summary>Validate for backup request</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IValidateForBackupRequest ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Cmdlets.TestAzDataProtectionBackupInstance_ValidateViaIdentityExpanded Clone()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BackupInstancesValidateForBackupViaIdentity(InputObject.Id, ParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupInstancesValidateForBackup(InputObject.VaultName ?? null, InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, ParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
