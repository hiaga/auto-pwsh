...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ResourceOperationGatekeepers_Patch=>PATCH:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/resourceOperationGateKeepers/{resourceOperationGateKeepersName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDataProtectionBackupResourceOperationGatekeeper_PatchViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IResourceOperationGateKeeperResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Description(@"Updates a ResourceOperationGatekeeper resource belonging to a resource group. For example, updating tags for a resource.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Generated]
    public partial class UpdateAzDataProtectionBackupResourceOperationGatekeeper_PatchViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.IEventListener
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.ParameterCategory.Body)]
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.IDataProtectionBackupIdentity _inputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.IDataProtectionBackupIdentity InputObject { get => this._inputObject; set => this._inputObject = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IPatchResourceRequestInput _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.PatchResourceRequestInput();

        /// <summary>Patch Request content for Microsoft.DataProtection resources</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IPatchResourceRequestInput ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.ExportAs(typeof(global::System.Collections.Hashtable))]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IPatchResourceRequestInputTags Tag { get => ParametersBody.Tag ?? null /* object */; set => ParametersBody.Tag = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.ICloudError"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.ICloudError> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IResourceOperationGateKeeperResource"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IResourceOperationGateKeeperResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ResourceOperationGatekeepersPatch' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ResourceOperationGatekeepersPatchViaIdentity(InputObject.Id, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ResourceOperationGatekeepersPatch(InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.ResourceOperationGateKeepersName ?? null, ParametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzDataProtectionBackupResourceOperationGatekeeper_PatchViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzDataProtectionBackupResourceOperationGatekeeper_PatchViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.ICloudError>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IResourceOperationGateKeeperResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IResourceOperationGateKeeperResource
