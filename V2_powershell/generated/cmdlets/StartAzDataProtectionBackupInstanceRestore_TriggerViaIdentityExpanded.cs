...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Description(@"Triggers restore for a BackupInstance")]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IAzureBackupRestoreRequest _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.AzureBackupRestoreRequest();

        /// <summary>Azure backup restore request</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Models.Api202001Alpha.IAzureBackupRestoreRequest ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Support.SourceDataStoreType SourceDataStoreType { get => ParametersBody.SourceDataStoreType; set => ParametersBody.SourceDataStoreType = value; }
        ...
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Cmdlets.StartAzDataProtectionBackupInstanceRestore_TriggerViaIdentityExpanded Clone()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.BackupInstancesTriggerRestoreViaIdentity(InputObject.Id, ParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.BackupInstancesTriggerRestore(InputObject.VaultName ?? null, InputObject.ResourceGroupName ?? null, InputObject.SubscriptionId ?? null, InputObject.BackupInstanceName ?? null, ParametersBody, onNoContent, onDefault, this, Pipeline);
                    }
