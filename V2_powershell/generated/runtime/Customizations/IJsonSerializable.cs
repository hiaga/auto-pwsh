...
using Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.DataProtectionBackup.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
