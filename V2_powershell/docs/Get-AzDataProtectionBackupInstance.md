...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/get-azdataprotectionbackupinstance
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzDataProtectionBackupInstance -InputObject <IDataProtectionBackupIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
