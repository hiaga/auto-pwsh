...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/get-azdataprotectionbackupresourceoperationgatekeeperresource
schema: 2.0.0
---

# Get-AzDataProtectionBackupResourceOperationGatekeeperResource
...
### Get (Default)
```
Get-AzDataProtectionBackupResourceOperationGatekeeperResource [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get1
```
Get-AzDataProtectionBackupResourceOperationGatekeeperResource -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataProtectionBackupResourceOperationGatekeeperResource -InputObject <IDataProtectionBackupIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
