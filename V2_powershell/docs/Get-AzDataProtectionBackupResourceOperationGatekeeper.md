...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/get-azdataprotectionbackupresourceoperationgatekeeper
schema: 2.0.0
---

# Get-AzDataProtectionBackupResourceOperationGatekeeper
...
### Get (Default)
```
Get-AzDataProtectionBackupResourceOperationGatekeeper -ResourceGroupName <String> -SName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataProtectionBackupResourceOperationGatekeeper -InputObject <IDataProtectionBackupIdentity>
