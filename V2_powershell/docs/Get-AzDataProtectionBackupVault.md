...
online version: https://docs.microsoft.com/en-us/powershell/module/az.dataprotectionbackup/get-azdataprotectionbackupvault
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzDataProtectionBackupVault -InputObject <IDataProtectionBackupIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
