# How-To
This document describes how to develop for `Az.RecoveryServicesBackup`.

## Building `Az.RecoveryServicesBackup`
...
## Testing `Az.RecoveryServicesBackup`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Az.RecoveryServicesBackup` into the session.
