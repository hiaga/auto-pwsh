...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recoveryservicesbackup/start-azrecoveryservicesbackupjobcancellation
schema: 2.0.0
---

# Start-AzRecoveryServicesBackupJobCancellation
...
### Trigger (Default)
```
Start-AzRecoveryServicesBackupJobCancellation -JobName <String> -ResourceGroupName <String>
...
### TriggerViaIdentity
```
Start-AzRecoveryServicesBackupJobCancellation -InputObject <IRecoveryServicesBackupIdentity>
