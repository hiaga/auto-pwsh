...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recoveryservicesbackup/set-azrecoveryservicesbackupprotectionpolicy
schema: 2.0.0
---
...
```
Set-AzRecoveryServicesBackupProtectionPolicy -PolicyName <String> -ResourceGroupName <String>
