...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recoveryservicesbackup/set-azrecoveryservicesbackupprotecteditem
schema: 2.0.0
---

# Set-AzRecoveryServicesBackupProtectedItem
...
```
Set-AzRecoveryServicesBackupProtectedItem -ContainerName <String> -FabricName <String> -Name <String>
