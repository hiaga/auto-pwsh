...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recoveryservicesbackup/get-azrecoveryservicesbackupprotectionpolicyoperationresult
schema: 2.0.0
---

# Get-AzRecoveryServicesBackupProtectionPolicyOperationResult
...
### Get (Default)
```
Get-AzRecoveryServicesBackupProtectionPolicyOperationResult -OperationId <String> -PolicyName <String>
...
### GetViaIdentity
```
Get-AzRecoveryServicesBackupProtectionPolicyOperationResult -InputObject <IRecoveryServicesBackupIdentity>
