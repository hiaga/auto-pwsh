...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recoveryservicesbackup/get-azrecoveryservicesbackupprotecteditemoperationresult
schema: 2.0.0
---

# Get-AzRecoveryServicesBackupProtectedItemOperationResult
...
### Get (Default)
```
Get-AzRecoveryServicesBackupProtectedItemOperationResult -ContainerName <String> -FabricName <String>
...
### GetViaIdentity
```
Get-AzRecoveryServicesBackupProtectedItemOperationResult -InputObject <IRecoveryServicesBackupIdentity>
