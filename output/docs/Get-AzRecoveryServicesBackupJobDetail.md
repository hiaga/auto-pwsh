...
online version: https://docs.microsoft.com/en-us/powershell/module/az.recoveryservicesbackup/get-azrecoveryservicesbackupjobdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzRecoveryServicesBackupJobDetail -JobName <String> -ResourceGroupName <String> -VaultName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecoveryServicesBackupJobDetail -InputObject <IRecoveryServicesBackupIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.RecoveryServicesBackup.Models.Api20190513.IJobResource
